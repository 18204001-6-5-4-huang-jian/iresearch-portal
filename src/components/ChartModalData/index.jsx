...
class ChartModal extends Component {
  ...
  render() {
    ...
    const chartColorPanel = (
      <ChartColorPanel
        chartConf={this.state.installConfig}
        ...
        <Row className="detail-trend-modal-content">
          <Col span={17}>
            <div className="trend-modal-content-left">
              ...
              {/* <div id="export-chartdata-container" /> */}
              {/* <div id="modal-chart" className="modal-content-left-chartContainer"></div>*/}
              <ReactHighcharts config={this.state.installConfig} ref="charts" />
            </div>
          </Col>
          <Col span={7}>
